...
import 'package:clean_point/features/driver/driver_request/view/driver_details_request_screen.dart';
...
import 'driver_track_order_screen.dart';

class DriverProcessScreen extends StatelessWidget {
  const DriverProcessScreen({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ButtonWidgetWithText(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => DriverTrackOrderScreen(),));
                    },
                    txt: "تحديث الحالة",
                    widthButton: MediaQuery.sizeOf(context).width / 1,
                    backgroundColor:AppColor.primaryColor,
                    sizeText: 14.0,
                    heightButton: 45.0,
                  ).center,
