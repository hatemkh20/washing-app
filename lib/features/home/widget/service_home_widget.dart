...
class ServiceHomeWidget extends StatefulWidget {
  const ServiceHomeWidget({super.key});
        ...
        children: [
          Row(
            ...
            children: [
              ...
              }, child: Text("اضف طلب", style: getSemiBoldStyle(color: AppColor.darkGreyColor3).copyWith(
              ...
              itemBuilder: (context, index) {
                ...
                return SizedBox(
                  ...
                  child: GestureDetector(
                    ...
                    child: Card(
                      elevation: 0.0,
                      color: (indexItem == index) ?  AppColor.primaryColor : Colors.transparent,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(15.0),
                        side: BorderSide(
                          color: (indexItem == index) ?  AppColor.primaryColor : AppColor.darkGreyColor3.withOpacity(0.2),
                        )
                      ),
